...
class MyHomePage extends StatelessWidget {
  ...
  final String nama = "Farrel Rifqi Bagaskoro"; //nama
  final String npm = "2406406780"; //npm
  ...
  @override
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Sefruit Shop" dengan teks putih dan tebal.
        title: const Text(
          'Sefruit Shop',
          style: TextStyle(
            color: Colors.white,
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Sefruit Shop',
                      style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18.0,
                      ),
